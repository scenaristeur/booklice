<template>
  <div id="app">
    ...
    <ul>
      ...
      <li v-if="path != null && path.length>0">
        Pour partager tes booklices :
        <a :href="'https://scenaristeur.github.io/booklice?source='+path"
        target="_blank">
        https://scenaristeur.github.io/booklice?source={{path}}
      </a>
